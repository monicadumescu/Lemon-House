    ...
    <div role="main">
      ...
      <div class="pt-5 pb-5 bg-light">
					...
					if($count)
					{
						while($row=$result->fetch_assoc())
						{
							...
							if($result_out)
							{
							  ...
							  <br>
							  <a class="btn btn-outline-success my-1 my-sm-1"  href="delete_basket_admin.php?id=<?php echo $row['id']; ?>" type="submit">Delete</a></div><br>
								<?php	}
								}
							}
						}
		...
		?>
         ...
         <p><a class="btn btn-primary btn-lg" href="order_admin.php" role="button">Order&raquo;</a></p>
		 </br><p>More shopping?</p>
         <p><a class="btn btn-primary btn-lg" href="home_admin.php" role="button">Home&raquo;</a></p>
      </div>
