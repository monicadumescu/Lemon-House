...
<br><button class="btn btn-outline-success my-2 my-sm-1" type="submit">Add to chart</button><br>
<button class="btn btn-outline-success my-1 my-sm-1" type="submit">Delete</button>
<?php }
 }
  else
 {
