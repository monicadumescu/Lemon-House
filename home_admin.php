 ...
 <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
     <a class="navbar-brand" href="home_admin.php">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <form action="search_admin.php" class="form-inline my-2 my-lg-0 method="get">
                 ...
                 die("Connection failed: " . $conn->connect_error);
				  ...
				  if($count >0)
				  {
					  ...
					  { 
							  ...
							  <br><a class="btn btn-outline-success my-2 my-sm-1" href="add_chart_admin.php?id=<?php echo $row['id']; ?>"  type="submit">Add to chart</a><br>
							  <a class="btn btn-outline-success my-1 my-sm-1" href="delete_product.php?id=<?php echo $row['id']; ?>"  type="submit">Delete</a></div><br>
							   
					  <?php }
				  }
				  else
				  {
					  echo "<br>There are no products";
				  }
